...
import { LogOut, Bell, UserRound, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="relative overflow-visible">
              ...
              <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => router.push("/dashboard/candidato/meu-perfil")}> 
        ...
        <main className="relative flex-1 overflow-auto bg-[linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--secondary)/0.25)_100%)]">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,hsl(var(--primary)/0.12),transparent_40%),radial-gradient(circle_at_bottom_left,hsl(var(--primary)/0.08),transparent_35%)]" />
